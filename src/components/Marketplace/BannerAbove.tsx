...
const BannerAbove = () => {
    const imges = ["/images/product/surface.webp","/images/product/plays.webp" , "/images/product/tayo.webp"]
    return (
                ...
                <div className="list-banner grid lg:grid-cols-3 sm:grid-cols-2 lg:gap-[30px] gap-[20px]">
                    <a href='/shop/breadcrumb-img'
                        ...
                        <div className="banner-img w-1/2 absolute top-1/2 -translate-y-1/2 right-10">
                            <Image width={5000} height={5000} src={imges[0]} className='w-full duration-500' alt='img' />
                        </div>
                    ...
                    <a href='/shop/breadcrumb-img'
                        ...
                        <div className="banner-img w-1/2 absolute top-1/2 -translate-y-1/2 right-10">
                            <Image width={5000} height={5000} src={imges[1]} className='w-full duration-500' alt='img' />
                        </div>
                        <div className="banner-content relative">
                    ...
                    <a href='/shop/breadcrumb-img'
                        ...
                        <div className="banner-img w-1/2 absolute top-1/2 -translate-y-1/2 right-10">
                            <Image width={5000} height={5000} src={imges[2]} className='w-full duration-500' alt='img' />
                        </div>
                        <div className="banner-content relative">
